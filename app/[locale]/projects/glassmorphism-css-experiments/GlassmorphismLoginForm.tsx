...
// there are two ways to create glass effect here:
// 1. using backdrop-blur and glass rim (thickness illusion)
// 2. using backdrop-blur and box-shadow
// the first option might have issues with backdrop-filter compositing bug (extra overlapping tiles on scroll/resize)
// the second option is more performant and doesn't have any issues
export function GlassmorphismLoginForm() {
  return (
    <div className="flex flex-col gap-8 items-center justify-center w-full px-4 shrink-0 min-h-screen">
      <section className="relative w-full max-w-7xl flex flex-wrap items-center justify-center overflow-hidden">
        <h2 className="text-3xl font-light text-white/90 tracking-widest uppercase text-center w-full mb-2 pt-8">Glassmorphism Login</h2>
        <p className="text-sm font-bold uppercase text-white/70 text-center w-full mb-8">Flat glass effect</p>

        <div className="relative w-full max-w-7xl  h-[80vh] flex flex-wrap items-center justify-center rounded-3xl overflow-hidden border border-white/20 shadow-2xl">
          {/* Background Image */}
      ...
      <section className="relative w-full max-w-7xl flex flex-wrap items-center justify-center overflow-hidden">
        <h2 className="text-3xl font-light text-white/90 tracking-widest uppercase text-center w-full mb-2 pt-8">Glassmorphism Login</h2>
        <p className="text-sm font-bold uppercase text-white/70 text-center w-full mb-8">Curved glass effect</p>
        ...
        <div className="absolute top-6 left-6 z-20">
          <Link
            href="/projects"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 c border border-white/20 text-white transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
            style={{
              boxShadow: 
