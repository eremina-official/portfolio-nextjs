...
export function Card({ project }: CardProps) {
  ...
  const { id, title, description, href, tech } = project;
  ...
  return (
    ...
    >
      ...
      <Link
        href={href}
        className="mt-6 inline-flex items-center text-sm font-medium text-primary transition hover:text-primary-dark"
      >
